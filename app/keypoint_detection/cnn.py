...
from keypoint_detection.mobilenet_custom import MobileNetCustom
...
def init_model(do_load_model, verbose=True):
...
# def init_model(sess, do_load_model, verbose=True):
#
# 	K.set_session(sess)
